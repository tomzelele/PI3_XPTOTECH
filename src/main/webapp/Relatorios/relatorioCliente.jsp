...
<div id="wrapper3">
    <div id="three-column" class="container">
        ...
        <div id="tbox1" class="paginaDeGerenciamento"> <span class="icon icon-signal"></span>
            <div id="textCustom" class="title">	<h2>Relatório de Clientes</h2> </div>
        </div>
            ...
            <div class="col-md-12">
                <div style="margin-top: -250px;" class="table-responsive">
                    <table     id="mytable" class="table table-bordred table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td  class="form-group" > <input type="text" class="form-control" placeholder="Id do Cliente"> </td>
                                <td  class="form-group" > <input type="text" class="form-control" placeholder="Nome Completo do Cliente"> </td>
